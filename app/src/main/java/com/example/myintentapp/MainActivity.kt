    ...
    override fun onClick(v: View) {
            when (v.id) {
                ...
                R.id.btn_move_to_personal_data -> {
                    ...
                    moveToPersonalDataIntent.putExtra(MoveToPersonalData.EXTRA_TITLE,
                        "BIODATA")
                    moveToPersonalDataIntent.putExtra(MoveToPersonalData.EXTRA_NAME,
                        "Muhammad Zacky Abdillah")
                    moveToPersonalDataIntent.putExtra(MoveToPersonalData.EXTRA_AGE,
                        18)
                    moveToPersonalDataIntent.putExtra(MoveToPersonalData.EXTRA_ADDRESS,
                        "Jl.Sememi Jaya VI No.26")
                    moveToPersonalDataIntent.putExtra(MoveToPersonalData.EXTRA_IDENTITY,
                        "XI RPL 3 (30)")
